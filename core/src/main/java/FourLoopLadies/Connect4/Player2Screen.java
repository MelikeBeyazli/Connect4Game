...
public class Player2Screen implements Screen {
    ...
    public Player2Screen(Game game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        selectedStone = GameSettings.player2StoneColor;
        selectedIconIndex = GameSettings.player2IconIndex;
        ...
        nameInput.setMessageText("Player 2 Name");
        ...
        nameInput.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, com.badlogic.gdx.scenes.scene2d.Actor actor) {
                playerName = nameInput.getText().isEmpty() ? "Player 2" : nameInput.getText();
                GameSettings.player2Name = playerName;
            }
        });
        ...
        for (int i = 0; i < stoneColors.length; i++) {
            ...
            button.addListener(new ClickListener() {
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    if(selectedColor!= GameSettings.player1StoneColor) {
                        GameSettings.player2StoneColor = selectedColor;
        ...
        for (int i = 0; i < iconCount; i++) {
            ...
            iconButton.addListener(new ClickListener() {
                public void clicked(InputEvent event, float x, float y) {
                    ...
                    if(selectedIconIndex!= GameSettings.player1IconIndex) {
                        GameSettings.player2IconIndex = index;
        ...
        ButtonConfig player2Config = new ButtonConfig("player2", "SettingScreen/player2nd_button_1.png", "SettingScreen/player2nd_button_0.png", 515.6f, 131.7f, 186.8f, 43.2f);
